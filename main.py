...
#widgets start from here
        self.lbl1 = Label(win,text="1st No." ,fg = "red")       #For Label Widget
        self.lbl1.place(x=100,y=50)
        self.lbl2 = Label(win, text= "2nd No." ,fg = "orange")
        self.lbl2.place(x=100,y=100)
        self.lbl3 = Label(win, text="Result" ,fg = "yellow")
        ...
        self.btnadd = Button(win,text="addition",command = self.add  ,fg = "green")
        self.btnadd.place(x=100,y=190)

        self.btnsub = Button(win,text="Sub"  ,fg = "blue")
        self.btnsub.place(x=180,y=190)
        self.btnsub.bind('<Button-1>',self.sub)

        self.btnmul = Button(win, text="Mul" ,fg = "indigo")
        self.btnmul.place(x=240, y=190)
        self.btnmul.bind('<Button-1>', self.mul)

        self.btndiv = Button(win, text="Div" ,fg = "violet")
